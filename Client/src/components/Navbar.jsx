...
const Navbar = () => {
      ...
      const{navigate,token}=useAppContext();//it will get navigate and token from context and use it in this component to navigate to different pages and check if user is authenticated or not
